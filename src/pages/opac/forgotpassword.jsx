...
const ForgotPassword = () => {
    ...
    return (
        <div>
            <div className="py-20 relative item-center justify-center bg-gradient-to-r from-red-300 to-gray-300 min-h-[549px] ">
                <div className="bg-white rounded-xl justify-center item-center shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-2xl min-h-[50%]">
